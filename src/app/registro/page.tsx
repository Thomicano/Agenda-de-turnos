...
export default function RegistroPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (error) {
      ...
      toast.error(messages[error.code ?? ""] ?? "Ocurrió un error al registrarse.");
      return;
    }

    toast.success("Cuenta creada. Por favor, revisá tu email para confirmar.", {
      duration: 6000,
    });
